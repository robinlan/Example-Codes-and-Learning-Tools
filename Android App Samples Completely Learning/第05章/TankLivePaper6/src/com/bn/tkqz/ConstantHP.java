...
public class ConstantHP {
	public static int SCREEN_HEIGHT=320;//屏幕高度
	public static int SCREEN_WIDTH=480;//屏幕宽度
	public static final int RIGHT_MARGIN=60;//屏幕右边留白宽度
	public static final int RIGHT_BAR=5;//屏幕右边条的宽度
	//游戏界面xy坐标
	public static int GAME_VIEW_X=Constant.LEFT_TOP_X;
	public static int GAME_VIEW_Y=Constant.LEFT_TOP_Y;
	public static int GAME_VIEW_WIDTH=SCREEN_WIDTH-RIGHT_MARGIN;;//游戏界面宽度
	public static int GAME_VIEW_HEIGHT=SCREEN_HEIGHT;//游戏界面高度
	
	public static final int NUMBER_WIDTH=12;//每一个数字占屏幕的宽度
	public static final int FIRST_MESSAGE_HEIGHT=25;//第一条信息的高度
	public static final int HANZI_HEIGHT=6;//汉字占屏幕的高度
	public static final int NUMBER_HEIGHT=28;//数字占屏幕的高度
