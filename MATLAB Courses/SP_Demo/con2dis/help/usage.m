%----------------------------------------------------------------------------
%Using the Con2Dis Graphical User Interface
%----------------------------------------------------------------------------
%
%----------------------------------------------------------------------------
%Overview
...
%
%  The Frequency (Fo) and Phase of the input sinusoid can be 
%  changed with the sliders and edit boxes at the bottom of the screen.
