function h = defaultplots(h,VersionCon2Dis)
...
% Rajbabu, Rev. 07-Feb-03: Reverted back to use, '.' and '*' for 
%                          real/complex stem in spectrum plot
%
%====================================================
% DEFINITIONS
%====================================================
...
set([h.RButton1,h.RButton2,h.RButton22],'Value',0);
...
h.TextFs = text(11.5,2,sprintf('f_s = %.1f (Hz)',Fs),... 
   'FontSize',12,'units','normalized','Fontweight','bold');
h.Version = text(25,0.15,VersionCon2Dis,'HorizontalAlignment','right',...
   'FontSize',10,'units','normalized','Fontweight','normal');
...
set(h.Axis3,'NextPlot','ReplaceChildren' ...% ,'FontSize',h.FontSize)
           ,'FontWeight','bold'...
           ,'FontSize',h.FontSize...
           ,'XLim',[-1.5 1.5] ...
           ,'YLim',[0 YSPMAX] ...
...
h.Group = [h.AxisRef,h.Axis1,h.Axis2,h.Axis3,h.Axis4,h.Editbox1,h.Editbox2, ...
           ...
           h.RButton1,h.RButton2,h.RButton22];
